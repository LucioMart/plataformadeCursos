...
class Course extends Model
{
    ...
    public function reviews() {
        return $this->hasMany(Reviews::class)->select('id', 'user_id', 'course_id', 'rating', 'comment', 'created_at');
    }

    public function requirements() {
        return $this->belongsToMany(Requirement::class)->select('id', 'course_id', 'requirement');
    }
